exports.seed = function(knex, Promise) {
  return knex('friendships').del()
    .then(function () {
      return Promise.all([
        knex('friendships').insert({id: 2001, requested_at: '2017-05-29 10:04:53.442085+00', responded_at: null, status: 'pending'}),
        ...
        knex('friendships').insert({id: 2004, requested_at: '2017-03-05 01:04:13.442085+00', responded_at: null, status: ''})
      ]);
    });
};
